  ...
  return (
    <section className="max-w-7xl mx-auto">
      ...
      <p className="mt-2 text-[#666e75] text-[16px] max-w[500px]">
        Unleash Your Imagination with DALL-E AI - Share Your Visual Masterpieces
        with the World
      </p>
      ...
      <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
        ...
        <div className="mt-5 flex gap-5">
          <button
            ...
            className=" text-white bg-green-500 font-medium rounded-md text-sm w-full sm:w-auto px-5 py-2.5"
          >
